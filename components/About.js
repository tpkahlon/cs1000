...
const About = () => {
  return (
    <div className="page">
      <h2 className="text-center m-0 mb-2 h3 featured">About</h2>
      <div className="text-center text-secondary mx-auto mt-0 mb-3">
        CS1000 is an open source project that beautify listing curated by{" "}
